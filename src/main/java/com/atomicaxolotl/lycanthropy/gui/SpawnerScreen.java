...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(Lycanthropy.MOD_ID, "textures/gui/spawner_gui.png");
